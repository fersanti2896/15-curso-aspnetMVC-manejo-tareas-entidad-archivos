...
namespace ManejoTareas.Services {
    public class AlmacenadorArchivosRepository : IAlmacenadorArchivosRepository {

        private readonly IWebHostEnvironment env;
        private readonly IHttpContextAccessor httpContextAccessor;

        public AlmacenadorArchivosRepository(IWebHostEnvironment env, IHttpContextAccessor httpContextAccessor) {
            this.env = env;
